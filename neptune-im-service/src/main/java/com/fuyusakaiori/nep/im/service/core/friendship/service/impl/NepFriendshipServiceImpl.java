...
public class NepFriendshipServiceImpl {
    ...
    public int doAddFriendship(NepRequestHeader header, NepAddFriendship body){
        ...
        if (Objects.isNull(friendshipFrom)){
            ...
            NepEditFriendship friendship = transferToEditFriendship(friendFromId, friendToId, remark, source, additionalInfo);
    ...
    private NepEditFriendship transferToEditFriendship(Integer friendFromId, Integer friendToId, String remark, String source, String additionalInfo) {
